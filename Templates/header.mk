...
#    Updated: 2023/04/08 12:35:20 by thzeribi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

RULE := $(filter all re clean fclean norm header asan,$(MAKECMDGOALS))
...
define print_header
	...
	printf "$(INFO_COLOR)|| $(OK_COLOR)\t\t\t\tCC: 	$(OBJ_COLOR)%-$(SPACE)s %b\033[m" "docker-compose" "$(INFO_COLOR)||\n"
